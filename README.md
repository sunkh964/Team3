...
| 재방문환자의 경우 기존 회원 데이터를 가져오게 되어, </br> 관리자가 바로 진료 정보를 등록하여 대기 접수가 가능합니다. | 환자 진료는 대기 / 진료 / 진료 완료 / 수납완료 상태로 나뉘어지며,</br> 화면과 같이 관리자가 각 환자의 진료 상태에 따라 대기 -> 진료 -> 진료 완료 -> 수납하기 를 진행할 수 있습니다.  |
