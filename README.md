...
#### // 진료예약 페이지입니다.
각 진료과에 대한 의료진 목록을 불러오며,
진료과 - 의료진 - 날짜 - 시간을 선택하고 증상을 입력한 후,
개인정보처리방침에 동의하게 되면 예약을 할 수 있습니다.
* 부가기능
 - 비회원의 경우, 로그인이 필요하다는 alert와 함께 로그인 페이지로의 이동이 이루어집니다.
 - 진료과 / 의료진의 경우 상단 항목이 자동 선택되어있습니다.
 - 날짜 / 시간 / 증상 / 개인정보처리방침 각 항목이 공란일 경우, 각 항목에 대한 확인이 필요하다는 alert와 함께 예약이 불가합니다.
